...
<!-- INICIA LA COLUMNA -->
  ...
  <div class="col-md-4">
    ...
    <form method="POST" action="enseres.php" >
    ...
    <div class="form-group">
        <label for="correo">Correo Elect&oacute;nico </label>
    ...
    include("abrir_conexion.php");
      ...
      {      
        ...
        if($doc=="" || $nombre=="" || $dir=="" || $tel=="" || $dui=="" || $correo=="" || $nsucursal==""){
          ...
          (doc,nombre,direccion,telefono,dui,correo,sucursal) 
          values 
          ('$doc','$nombre','$dir','$tel','$dui','$correo','$nsucursal')");
      ...
      if(isset($_POST['btn_consultar']))
      {
        ...
        if($doc==""){
          ...
          while($consulta = mysqli_fetch_array($resultados))
          {
            ...
            echo $consulta['dui']."<br>";
            echo $consulta['correo']."<br>";
            echo $consulta['sucursal']."<br>";
            $existe++;
          }
