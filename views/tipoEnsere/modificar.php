<?php 
	...
	$md = new Model();
	$cn = $md->getConexion();
	$sqlMostrar = "SELECT * FROM tipo_ensere WHERE idtipo= '".$_GET['id']."'";
 ...
 <?php   require('../head.php') ?>
	...
	<body style="background: #f5f6fa;">
		...
		<h1 style="margin: 0 auto; display: block; text-align: center;">Modificar Tipo del Ensere</h1>
...
<form action="../../controllerTipo.php?op=update&id=<?php echo $_GET['id']?>" method="POST">
