...
<th>Tipo</th>
<th>Fecha </th> 
<th><a href="nuevo.php" class="btn btn-primary">Nuevo</a></th>
</tr>
</thead>
<tbody>
<?php
...
$md = new Model();
		...
		while($row = mysqli_fetch_assoc($res)){
           ...
           // echo "<a href='modificar.php?id=".$row['id_enseres']."' class='btn btn-primary'>Modificar</a>";
                         echo "<a href='modificar.php?id=".$row['id_enseres']."' class='btn btn-warning'>Modificar</a></td><td>";

            echo "<a href='../../controllerEnseres.php?op=eliminar&id=".$row['id_enseres']."' class='btn btn-primary'>Eliminar</a>";
            echo "</td></tr>\n";
        }
?>
</tbody>
